...
extension UnicodeEncoding where Terminal: ASCIITerminal {
    ...
    /// All ``ASCIITerminal`` types can match the letter `'a'`
    /// (`0x61`).
    public enum LowercaseA: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x61) }
    }
    /// Matches the uppercase letter `'A'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'A'`
    /// (`0x41`).
    public enum UppercaseA: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x41) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'b'`
    /// (`0x62`).
    public enum LowercaseB: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x62) }
    }
    /// Matches the uppercase letter `'B'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'B'`
    /// (`0x42`).
    public enum UppercaseB: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x42) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'c'`
    /// (`0x63`).
    public enum LowercaseC: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x63) }
    }
    /// Matches the uppercase letter `'C'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'C'`
    /// (`0x43`).
    public enum UppercaseC: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x43) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'d'`
    /// (`0x64`).
    public enum LowercaseD: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x64) }
    }
    /// Matches the uppercase letter `'D'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'D'`
    /// (`0x44`).
    public enum UppercaseD: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x44) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'e'`
    /// (`0x65`).
    public enum LowercaseE: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x65) }
    }
    /// Matches the uppercase letter `'E'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'E'`
    /// (`0x45`).
    public enum UppercaseE: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x45) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'f'`
    /// (`0x66`).
    public enum LowercaseF: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x66) }
    }
    /// Matches the uppercase letter `'F'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'F'`
    /// (`0x46`).
    public enum UppercaseF: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x46) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'g'`
    /// (`0x67`).
    public enum LowercaseG: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x67) }
    }
    /// Matches the uppercase letter `'G'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'G'`
    /// (`0x47`).
    public enum UppercaseG: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x47) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'h'`
    /// (`0x68`).
    public enum LowercaseH: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x68) }
    }
    /// Matches the uppercase letter `'H'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'H'`
    /// (`0x48`).
    public enum UppercaseH: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x48) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'i'`
    /// (`0x69`).
    public enum LowercaseI: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x69) }
    }
    /// Matches the uppercase letter `'I'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'I'`
    /// (`0x49`).
    public enum UppercaseI: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x49) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'j'`
    /// (`0x6a`).
    public enum LowercaseJ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6a) }
    }
    /// Matches the uppercase letter `'J'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'J'`
    /// (`0x4a`).
    public enum UppercaseJ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4a) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'k'`
    /// (`0x6b`).
    public enum LowercaseK: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6b) }
    }
    /// Matches the uppercase letter `'K'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'K'`
    /// (`0x4b`).
    public enum UppercaseK: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4b) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'l'`
    /// (`0x6c`).
    public enum LowercaseL: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6c) }
    }
    /// Matches the uppercase letter `'L'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'L'`
    /// (`0x4c`).
    public enum UppercaseL: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4c) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'m'`
    /// (`0x6d`).
    public enum LowercaseM: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6d) }
    }
    /// Matches the uppercase letter `'M'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'M'`
    /// (`0x4d`).
    public enum UppercaseM: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4d) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'n'`
    /// (`0x6e`).
    public enum LowercaseN: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6e) }
    }
    /// Matches the uppercase letter `'N'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'N'`
    /// (`0x4e`).
    public enum UppercaseN: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4e) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'o'`
    /// (`0x6f`).
    public enum LowercaseO: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x6f) }
    }
    /// Matches the uppercase letter `'O'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'O'`
    /// (`0x4f`).
    public enum UppercaseO: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x4f) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'p'`
    /// (`0x70`).
    public enum LowercaseP: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x70) }
    }
    /// Matches the uppercase letter `'P'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'P'`
    /// (`0x50`).
    public enum UppercaseP: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x50) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'q'`
    /// (`0x71`).
    public enum LowercaseQ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x71) }
    }
    /// Matches the uppercase letter `'Q'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'Q'`
    /// (`0x51`).
    public enum UppercaseQ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x51) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'r'`
    /// (`0x72`).
    public enum LowercaseR: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x72) }
    }
    /// Matches the uppercase letter `'R'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'R'`
    /// (`0x52`).
    public enum UppercaseR: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x52) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'s'`
    /// (`0x73`).
    public enum LowercaseS: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x73) }
    }
    /// Matches the uppercase letter `'S'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'S'`
    /// (`0x53`).
    public enum UppercaseS: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x53) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'t'`
    /// (`0x74`).
    public enum LowercaseT: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x74) }
    }
    /// Matches the uppercase letter `'T'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'T'`
    /// (`0x54`).
    public enum UppercaseT: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x54) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'u'`
    /// (`0x75`).
    public enum LowercaseU: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x75) }
    }
    /// Matches the uppercase letter `'U'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'U'`
    /// (`0x55`).
    public enum UppercaseU: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x55) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'v'`
    /// (`0x76`).
    public enum LowercaseV: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x76) }
    }
    /// Matches the uppercase letter `'V'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'V'`
    /// (`0x56`).
    public enum UppercaseV: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x56) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'w'`
    /// (`0x77`).
    public enum LowercaseW: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x77) }
    }
    /// Matches the uppercase letter `'W'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'W'`
    /// (`0x57`).
    public enum UppercaseW: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x57) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'x'`
    /// (`0x78`).
    public enum LowercaseX: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x78) }
    }
    /// Matches the uppercase letter `'X'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'X'`
    /// (`0x58`).
    public enum UppercaseX: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x58) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'y'`
    /// (`0x79`).
    public enum LowercaseY: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x79) }
    }
    /// Matches the uppercase letter `'Y'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'Y'`
    /// (`0x59`).
    public enum UppercaseY: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x59) }
    }
    ...
    /// All ``ASCIITerminal`` types can match the letter `'z'`
    /// (`0x7a`).
    public enum LowercaseZ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x7a) }
    }
    /// Matches the uppercase letter `'Z'`.
    ///
    /// All ``ASCIITerminal`` types can match the letter `'Z'`
    /// (`0x5a`).
    public enum UppercaseZ: AtomicRule {
        @inlinable public static var terminal: Terminal { .init(0x5a) }
    }
}
