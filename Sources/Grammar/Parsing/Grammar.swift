...
public typealias _NoDiagnostics = NoDiagnostics
@available(*, deprecated, renamed: "DefaultDiagnostics")
public typealias _DefaultDiagnostics = DefaultDiagnostics
...
public enum Grammar {
    ...
    */
    ...
    ```
    */
    public typealias Parsable<Location, Terminal, Diagnostics> = Never
        where   Diagnostics: ParsingDiagnostics,
    ...
    public typealias Encoding = UnicodeEncoding

    @available(*, deprecated, renamed: "ParsingRule.parse(diagnosing:)")
    @inlinable public static func parse<Source, Root>(
        diagnosing source: Source,
        as _: Root.Type
    ) throws -> Root.Construction
    ...
    @inlinable public static func parse<Source, Rule, Vector>(
        _ source: Source,
        as _: Rule.Type,
        in _: Vector.Type
    ) throws -> Vector
    ...
    public typealias TerminalSequence  = LiteralRule

    @available(*, deprecated, renamed: "TerminalRule")
    public typealias TerminalClass     = TerminalRule

    /// ``Grammar/NoDiagnostics`` was moved to the top-level
    /// namespace of this module.
    @available(*, deprecated, renamed: "NoDiagnostics")
    public typealias NoDiagnostics = _NoDiagnostics

    /// ``Grammar/DefaultDiagnostics`` was moved to the top-level
    /// namespace of this module.
    @available(*, deprecated, renamed: "DefaultDiagnostics")
    public typealias DefaultDiagnostics = _DefaultDiagnostics

    @available(*, deprecated, renamed: "Pattern.End")
    public typealias End<Location, Terminal> = Pattern.End<Location, Terminal>

    @available(*, deprecated, renamed: "Pattern.Discard")
    public typealias Discard<Rule> = Pattern.Discard<Rule>
        where   Rule: ParsingRule, Rule.Construction == Void

    @available(*, deprecated, renamed: "Pattern.Collect")
    public typealias Collect<Rule, Construction> = Pattern.Collect<Rule, Construction>
    ...
    public typealias Reduce<Rule, Construction> = Pattern.Reduce<Rule, Construction>
        where   Rule: ParsingRule, Rule.Construction == Construction.Element,
        Construction: RangeReplaceableCollection

    @available(*, deprecated, renamed: "Pattern.Join")
    public typealias Join<Rule, Separator, Construction> = Pattern.Join<
        Rule,
        Separator,
        Construction
    >
    ...
    public typealias Pad<Rule, Padding> = Pattern.Pad<Rule, Padding>
    ...
    public typealias   NaturalDecimalDigit<Location, Terminal, Construction> =
