...
@frozen public struct ParsingInput<Diagnostics> where Diagnostics: ParsingDiagnostics {
    ...
    @inlinable public mutating func group<Rule, Construction>(
        _: Rule.Type,
        _ body: (inout Self) throws -> Construction
    ) throws -> Construction {
    ...
    @inlinable public mutating func parse<Rule>(as _: Rule.Type) throws -> Rule.Construction
    ...
    @discardableResult
    @inlinable public mutating func parse<T0, T1>(as _: (T0, T1).Type) throws
    -> (T0.Construction, T1.Construction)
        where   T0: ParsingRule<
            Diagnostics.Source.Element
        >, T0.Location == Diagnostics.Source.Index,
    ...
    @discardableResult
    @inlinable public mutating func parse<T0, T1, T2>(as _: (T0, T1, T2).Type) throws
    ...
    @discardableResult
    @inlinable public mutating func parse<T0, T1, T2, T3>(as _: (T0, T1, T2, T3).Type) throws
...
extension ParsingInput {
    ...
    @inlinable public mutating func parse<Rule>(as _: Rule.Type, in _: Void.Type)
